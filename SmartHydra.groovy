...
*  
* 
*  SmartScheduler SmartApp for a Hydrawise Lawn Contoller
*  Compatible with up to 24 Zones
*
*  Based on the Irrigation Scheduler App by
*  Stan Dotson (stan@dotson.info) and Matthew Nichols (matt@nichols.name)
*
*  Author: Curt Ruhlman (curt@ruhlman.us)
*  Date: 2017-02-14
*
*  Copyright 2017 Curtis S Ruhlman
*
